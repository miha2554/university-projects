    ...
    class Program
    {
        ...
        met:
            ...
            if (c % d == 0)
            {
                ...
                Console.WriteLine("Общее решение ЛДУ ax+by=c есть пары: (x0, y0) = ({0} - {1}t, {2} + {3}t)\n", x0, b, y0, a);
                ...
                else
                {
                    ...
                    //Console.WriteLine("\nЧастное решение ЛДУ {0}x + {1}y = {2} : ", a, b, c);

                    //for (int i = 0; i < k; i++)
                    //{
                    // Console.Write("(" + xi[i] + ", " + yi[i] + ")\n");
                    // }
                }
            }
            ...
            {
                Console.WriteLine("ЛДУ ax + by = c не имеет решения в целых числах\n");
                goto met;
            }
